    ...
    >
      ...
      <div className="flex items-start justify-between gap-3 pb-3 border-b border-stone-100 dark:border-stone-800">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-lg bg-indigo-500/10 dark:bg-indigo-500/20 text-indigo-700 dark:text-indigo-400 flex items-center justify-center font-mono font-bold text-base border border-indigo-500/20 dark:border-indigo-500/30 shrink-0">
            T
          </div>
          <div>
      ...
      <div className="mt-4 p-4 rounded-xl bg-stone-900 dark:bg-stone-950 border border-transparent dark:border-stone-800 text-stone-100 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        {/* Mode switcher pills */}
        <div className="flex items-center bg-stone-800 dark:bg-stone-900 p-1 rounded-lg text-xs gap-1 border border-stone-700/60">
          <button
            type="button"
        ...
        <div
          className={`p-3.5 rounded-lg border transition-all ${
            data.codingCompleted 
              ...
              : 'bg-stone-50/50 dark:bg-stone-800/40 border-stone-200/80 dark:border-stone-700/60'
          }`}
        >
