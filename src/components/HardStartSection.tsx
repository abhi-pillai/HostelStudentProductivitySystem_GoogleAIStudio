  ...
  return (
    <section 
      ...
      className={`bg-white dark:bg-stone-900 border rounded-xl p-5 mb-5 shadow-2xs transition-all ${
        earned
          ? 'border-amber-300/80 dark:border-amber-800/60 ring-1 ring-amber-400/15'
    ...
    >
      ...
      <div className="flex items-start justify-between gap-3 pb-3 border-b border-stone-100 dark:border-stone-800">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-amber-500/10 dark:bg-amber-500/15 text-amber-700 dark:text-amber-400 border border-amber-500/25 flex items-center justify-center font-mono font-bold text-sm shrink-0">
            H
          </div>
          <div>
            <div className="flex items-center gap-2">
              ...
              {earned ? (
                <span className="text-xs font-semibold text-amber-700 dark:text-amber-400 px-2 py-0.5 rounded-md bg-amber-500/10 border border-amber-500/25 flex items-center gap-1">
