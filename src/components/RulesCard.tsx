    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-stone-900/60 backdrop-blur-xs">
      ...
      >
        ...
        <div className="mt-4 space-y-4 text-xs leading-relaxed text-stone-700">
          {/* Core premise */}
          <div className="p-3.5 rounded-xl bg-amber-50 border border-amber-200/70">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              <div className="p-2.5 rounded-lg border border-stone-100 bg-stone-50">
                <span className="font-bold text-stone-900">1. H — Hard Start:</span> Start day with 15–20 aptitude questions before touching phone.
              </div>
              <div className="p-2.5 rounded-lg border border-stone-100 bg-stone-50">
                <span className="font-bold text-stone-900">2. O — Organize:</span> Lock in Top 3 essential priorities before leaving for college.
              </div>
              <div className="p-2.5 rounded-lg border border-stone-100 bg-stone-50">
                <span className="font-bold text-stone-900">3. S — Small Sessions:</span> Turn 20–30 min college breaks into coding or CS concept review.
              </div>
              <div className="p-2.5 rounded-lg border border-stone-100 bg-stone-50">
                <span className="font-bold text-stone-900">4. T — Targeted Evening:</span> Deep work block (1 hr coding, 45 min project, 30 min GATE/prep).
              </div>
              <div className="p-2.5 rounded-lg border border-stone-100 bg-stone-50">
                <span className="font-bold text-stone-900">5. E — Entertainment Limits:</span> Leisure only after 9:30 PM, strictly capped at 30 minutes.
              </div>
              <div className="p-2.5 rounded-lg border border-stone-100 bg-stone-50">
                <span className="font-bold text-stone-900">6. L — Lights Out:</span> Screen cutoff 20m before bed, sleep 11:00–12:00, bed only for sleep.
              </div>
            </div>
          </div>
          ...
          {/* Scoring rubric */}
          <div>
            <h4 className="font-bold text-stone-900 text-sm mb-1.5 flex items-center gap-1.5">
              <Award className="w-4 h-4 text-amber-600" />
              Daily Score System (Max: 6)
            </h4>
            <div className="space-y-1 text-stone-600 bg-stone-50 p-3 rounded-lg border border-stone-100">
              <p><strong className="text-emerald-700">6:</strong> Excellent execution</p>
              <p><strong className="text-teal-700">5:</strong> Strong day</p>
              <p><strong className="text-amber-700">4:</strong> Acceptable progress</p>
              <p><strong className="text-orange-700">3:</strong> Weak execution</p>
              <p><strong className="text-rose-700">0–2:</strong> System reset required</p>
            </div>
          </div>

          {/* Cardinal Hostel Rule */}
          <div className="p-3.5 rounded-xl bg-rose-50 border border-rose-200/70">
            <h4 className="font-bold text-rose-950 flex items-center gap-1.5 mb-1">
          ...
          <div className="p-3.5 rounded-xl bg-stone-100 border border-stone-200">
            <h4 className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">
